...
// Main config file for all aspects of the firmware
...
#define MAX_HDOP 600 //HDOP 200 = 2.0
...
#define LORAPORT TRACTORLORAPORT

#define TIME_BETWEEN_STATE_SEND 60 // s --- Time interval for sampling the state accumulator and sending the states
